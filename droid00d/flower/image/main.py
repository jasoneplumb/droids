...
if (len(A_IMAGES) == 0): ShowErrorMessageAndExit('No .bin found in /images/a/')
A_INDEX = random.randint(0,len(A_IMAGES)-1)
A_PATH = A_IMAGES[A_INDEX]
# The B image is in the middle
B_IMAGES = BinFilesIn('images/b')
if (len(B_IMAGES) == 0): ShowErrorMessageAndExit('No .bin found in /images/b/')
...
if (len(C_IMAGES) == 0): ShowErrorMessageAndExit('No .bin found in /images/c/')
